...
//Liens de test
// phpsql/mysql_ajouterLienTag.php?milis=123450&id_tag=72&str_section=impacts_tags&id_type_tag=21&id_toc=68332&code_user=FRO
...
//--------------------------------------------------------------------------
$message = "<ul><li>[".$arrayValeur["id_type_tag"]."]=>".$arrayValeur["id_tag"]."</li></ul>";

$strSql = "INSERT INTO `".$prefixTable."tab_tags_affecte`
    (`id_toc`,`id_type`,`id_tag`,`actif`,`dateTime_creation`,`auteur_creation`)
    VALUES
    (".$arrayValeur["id_toc"].",".$arrayValeur["id_type_tag"].",".$arrayValeur["id_tag"].",1,NOW(),'".$arrayValeur["code_user"]."')
;
