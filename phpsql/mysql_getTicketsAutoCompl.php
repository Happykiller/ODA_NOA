...
//Liens de test
// phpsql/mysql_getTicketsAutoCompl.php?milis=123450&ctrl=ok&recherche=1403
...
//--------------------------------------------------------------------------
$strSql = "SELECT a.`id`,a.`label`, CONCAT('T',a.`label`) as 'valeur'
    FROM  `".$prefixTable."tab_tickets` a
    WHERE 1=1
    AND a.`label` like '%".$arrayValeur["recherche"]."%'
    ORDER BY `label` DESC
    LIMIT 0 , 30
;";
