...
//Liens de test
// phpsql/mysql_ajouterFiltre.php?milis=123450&champs=nature&code_user=FRO&valeur=32
...
$strSql = "UPDATE `tab_filtres_users` a
    SET a.`".$arrayValeur["champs"]."` = concat(a.`".$arrayValeur["champs"]."`, '\"".$arrayValeur["valeur"]."\";')
    WHERE 1=1
